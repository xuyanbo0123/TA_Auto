...
-- XYB: 20130730
-- XYB: Add `lead_id` field into Lead_Request Table

-- XYB: 20130731
-- XYB: Add `comment`, `post_url`, `post_entity` field into Table: Click_Impression
-- XYB: Update an Unique_Key for Table: Click_Impression
-- XYB: Change all `token` size from 63 to 255

-- XYB: 20130801
-- XYB: Add `click_ad_position` into Table: Redirect_Action
-- XYB: Change `destination_url` size from 127 to 1023 for Table: Redirect
...
`lead_id`  varchar(63) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
PRIMARY KEY (`id`),
FOREIGN KEY (`arrival_id`) REFERENCES `Arrival` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
FOREIGN KEY (`buyer_account_id`) REFERENCES `Buyer_Account` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
UNIQUE INDEX `click_impression_unique_key` (`click_impression_request_id`, `buyer_account_id`) USING BTREE,
INDEX `token` (`token`) USING BTREE
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
...
token varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
destination_url varchar(1023) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
PRIMARY KEY (`id`),
INDEX `token` (`token`) USING BTREE
)
ENGINE=InnoDB
...
`click_ad_position`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
PRIMARY KEY (`id`),
