...
`created_ts`  timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ,
`updated_ts`  timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ,
`lead_request_id`  int(11) NOT NULL ,
`user_id`  int(11) NULL DEFAULT NULL ,
`coverage`  enum('State_Minimum','Basic_Coverage','Standard_Coverage','Superior_Coverage') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`current_insured`  tinyint(1) NULL DEFAULT 1 ,
`current_carrier`  varchar(127) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`current_exp`  date NULL DEFAULT NULL ,
`years_insured`  varchar(127) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`current_liability`  varchar(127) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
...
`type`  varchar(127) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
...
INDEX `incident_type` (`type`) USING BTREE
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
AUTO_INCREMENT=1
...
`ownership`  enum('Owned','Financed','Leased') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`use`  enum('Commute','Pleasure','Business') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`mileage`  int(11) NULL DEFAULT NULL ,
`parking`  enum('Private_Garage','Garage','Carport','Driveway','Parking_Lot','Street') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
PRIMARY KEY (`id`),
FOREIGN KEY (`auto_form_id`) REFERENCES `Auto_Form` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
`updated_ts`  timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ,
`auto_form_id`  int(11) NOT NULL ,
`relationship`  enum('Self','Spouse','Parent','Sibling','Child','Grandparent','Grandchild','Other') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
...
`marital`  enum('Single','Married','Divorced','Widowed') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`occupation`  varchar(127) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`education`  varchar(127) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`residence`  enum('Own','Rent','Other') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`credit`  enum('Excellent','Good','Average','Poor','Unsure') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL ,
`age_lic`  int(11) NULL DEFAULT NULL ,
...
`lead_request_id`  int(11) NOT NULL,
`buyer_account_id`  int(11) NOT NULL,
`sell_state`  enum('error','sold', 'rejected') CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
`amount`  DECIMAL(9,3) DEFAULT NULL ,
`adjusted_amount`  DECIMAL(9,3) DEFAULT NULL ,
`comment`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL ,
