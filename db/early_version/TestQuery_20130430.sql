-- KS: I added a `name` field to the Traffic_Source table, considering source corresponds to clients in Google, it needs a name. Made it allow null for safe compatibility
