--Change Log--
--20130428 v3 by lps-
--add unique key(ad_group_id, keyword_id, match_type) to table Ad_Group_Keyword
--add enum value 'active' into 'provider_status' for Table: Ad_Group_Ad and Ad_Group_Keyword by xyb on 20130625
