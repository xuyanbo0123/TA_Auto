...
public class Email {
    ...
    public Email(String iEmailAddress)
    {
        //mEmailAddress = filter(iEmailAddress);
    ...
    public String getEmailDomain(){
        ...
        Matcher m = p.matcher(mEmailAddress.toLowerCase());
        if (m.find())
        {
            Pattern pSimple = Pattern.compile("@(.+)");
            Matcher mSimple = pSimple.matcher(mEmailAddress.toLowerCase());
            if (mSimple.find())
            {
    ...
    private static String filter(String iValue)
    {
        if(iValue != null){
            ...
            Matcher m = p.matcher(iValue.toLowerCase());
    ...
    public static Email parseEmail(String iValue)
    {
