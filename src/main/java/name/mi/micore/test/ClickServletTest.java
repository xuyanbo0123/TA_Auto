...
//    http://192.168.1.144:8080/ta-auto/Click?arrival_id=326927&zip_code=02139&lead_type=AutoInsurance&location=after_form&site_name=Quotes2Compare&lead_request_id=3419
        ...
        throws Exception
    {
        ...
        vList.add(new BasicNameValuePair("arrival_id", "326927"));
        vList.add(new BasicNameValuePair("zip_code", "02139"));
        vList.add(new BasicNameValuePair("lead_type", "AutoInsurance"));
        vList.add(new BasicNameValuePair("location", "after_form"));
        vList.add(new BasicNameValuePair("site_name", "Quotes2Compare"));
        vList.add(new BasicNameValuePair("lead_request_id", ""));

        System.err.println("before response at " + new Date());

        String
            vResponse = postParameters(
            "http://192.168.1.144:8080/ta-auto/Click",
            20 * 1000,
