...
public class RedirectServletTest {
        ...
        throws Exception
    {
        ...
        vList.add(new BasicNameValuePair("action", "redirect"));
        vList.add(new BasicNameValuePair("token", "ProGuideAutoInsurance-2013-08-06-7adadc4c-b10a-4540-8544-c96bc6f71acf"));
        vList.add(new BasicNameValuePair("click_link", "testUrlForNoToken"));
        vList.add(new BasicNameValuePair("impression_zone", "main"));
        vList.add(new BasicNameValuePair("click_ad_position", "3"));

        System.err.println("before response at " + new Date());

        String
            vResponse = postParameters(
            "http://localhost:8080/ta-auto/Redirect",
            20 * 1000,
