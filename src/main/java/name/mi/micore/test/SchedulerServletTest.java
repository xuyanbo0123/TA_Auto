...
//        vList.add(new BasicNameValuePair("task", "addCronJob"));
        vList.add(new BasicNameValuePair("task", "listAllJobs"));
//        vList.add(new BasicNameValuePair("task", "pauseJob"));
//        vList.add(new BasicNameValuePair("task", "pauseAll"));
//        vList.add(new BasicNameValuePair("task", "resumeJob"));
//        vList.add(new BasicNameValuePair("task", "resumeAll"));
//        vList.add(new BasicNameValuePair("job", "HelloJob"));
//        vList.add(new BasicNameValuePair("schedule", "0/10 * * * * ?"));
//        vList.add(new BasicNameValuePair("job_name", "job2"));
//        vList.add(new BasicNameValuePair("trigger_name", "trigger2"));
//        vList.add(new BasicNameValuePair("group_name", "TestGroup"));

        System.err.println("before response at " + new Date());

        String
                vResponse = postParameters(
                "http://localhost:8080/ta-auto/Scheduler",
                20 * 1000,
