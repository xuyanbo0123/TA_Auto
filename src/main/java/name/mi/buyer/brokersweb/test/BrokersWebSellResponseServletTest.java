...
public class BrokersWebSellResponseServletTest {
    ...
    public static void main(String... iArgs)
            throws Exception
    {
        testBrokersWebSellResponse();
    }

    private static void testBrokersWebSellResponse()
            throws Exception
    {
        ArrayList<NameValuePair>
                vList = new ArrayList<NameValuePair>();

        vList.add(new BasicNameValuePair("token", "Quotes2Compare-2013-12-29-0a333afb-5073-49ec-ac96-759a2a6450d9"));
        ...
        String
                ...
                "http://localhost:8080/ta-auto/BrokersWebSellResponse",
                20 * 1000,
