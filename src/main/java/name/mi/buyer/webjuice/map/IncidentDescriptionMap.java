...
public class IncidentDescriptionMap
{
    ...
    static {
        ...
        vMap.put(IncidentDescription._TICKET_SPEEDING_LESS_THAN_10_MPH_OVER, "Speeding less than 10 MPH over");
        vMap.put(IncidentDescription._TICKET_SPEEDING_MORE_THAN_10_MPH_OVER, "Speeding more than 10 MPH over");
        vMap.put(IncidentDescription._TICKET_SPEEDING_MORE_THAN_20_MPH_OVER, "Speeding more than 20 MPH over");
        ...
        vMap.put(IncidentDescription._TICKET_ALCOHOL_RELATED_DUI_DWAI, "Alcohol or Drug related violation");
        ...
        vMap.put(IncidentDescription._TICKET_OTHER_UNLISTED_MOVING_VIOLATION, "Other Ticket");
        ...
        vMap.put(IncidentDescription._TICKET_RECKLESS_DRIVING, "Reckless Driving - no Injury");
        vMap.put(IncidentDescription._TICKET_RECKLESS_ENDANGERMENT, "Reckless Driving - Injury");
        vMap.put(IncidentDescription._TICKET_WRONG_WAY_ON_A_ONE_WAY, "Wrong way on a one way");
        vMap.put(IncidentDescription._ACCIDENT_COLLIDED_WITH_ANOTHER_CAR, "Vehicle Hit Vehicle");
        ...
        vMap.put(IncidentDescription._ACCIDENT_OTHER, "Not Listed");  //Other accident
        ...
        vMap.put(IncidentDescription._CLAIM_OTHER,"Other"); //Other claim
