...
public class CompanyMap
{
    ...
    static
    {
        ...
        vMap.put(Company._AMERICAN_INTERNATIONAL_INS,"American International Insurance");
        ...
        vMap.put(Company._AMERICAN_STANDARD_INSURANCE_OH,"American Standard Insurance");
        vMap.put(Company._AMERICAN_STANDARD_INSURANCE_WI,"American Standard Insurance");
        ...
        vMap.put(Company._CLARENDON_NATIONAL_INSURANCE,"Clarendon");
        vMap.put(Company._CNA,"CNA");
        vMap.put(Company._COLONIAL_INSURANCE,"Colonial Insurance");
        vMap.put(Company._CONTINENTAL_CASUALTY,"Continental Insurance");
        vMap.put(Company._CONTINENTAL_DIVIDE_INSURANCE,"Continental Insurance");
        ...
        vMap.put(Company._DAIRYLAND_COUNTY_MUTUAL_CO_OF_TX,"Dairyland Insurance");
        ...
        vMap.put(Company._ERIE,"Erie Insurance");
        ...
        vMap.put(Company._INFINITY_NATIONAL_INSURANCE,"Infinity Insurance");
        vMap.put(Company._INFINITY_SELECT_INSURANCE,"Infinity Insurance");
        ...
        vMap.put(Company._MIDWEST_NATIONAL_LIFE,"Mega/Midwest");
        vMap.put(Company._MSI_INSURANCE,"Company not listed");
        vMap.put(Company._MUTUAL_OF_NEW_YORK,"Mutual Insurance");
        vMap.put(Company._MUTUAL_OF_OMAHA,"Mutual Insurance");
        vMap.put(Company._NATIONAL_BEN_FRANKLIN_INSURANCE,"National Insurance");
        vMap.put(Company._NATIONAL_CASUALTY,"National Insurance");
        vMap.put(Company._NATIONAL_CONTINENTAL_INSURANCE,"National Insurance");
        vMap.put(Company._NATIONAL_FIRE_INSURANCE_COMPANY_OF_HARTFORD,"National Insurance");
        vMap.put(Company._NATIONAL_HEALTH_INSURANCE,"National Insurance");
        vMap.put(Company._NATIONAL_INDEMNITY,"National Insurance");
        vMap.put(Company._NATIONAL_UNION_FIRE_INSURANCE_OF_LA,"National Union Fire Insurance");
        vMap.put(Company._NATIONAL_UNION_FIRE_INSURANCE_OF_PA,"National Union Fire Insurance");
        ...
        vMap.put(Company._OMNI_INDEMNITY,"Omni Insurance");
        vMap.put(Company._OMNI_INSURANCE,"Omni Insurance");
        vMap.put(Company._ORION_INSURANCE,"Orion Insurance");
        vMap.put(Company._PACIFIC_INDEMNITY,"Pacific Insurance");
        ...
        vMap.put(Company._RELIANCE_NATIONAL_INDEMNITY,"Reliance Insurance");
        vMap.put(Company._RELIANCE_NATIONAL_INSURANCE,"Reliance Insurance");
        ...
        vMap.put(Company._SAFEWAY_INSURANCE_CO_OF_AL,"Safeway Insurance");
        vMap.put(Company._SAFEWAY_INSURANCE_CO_OF_GA,"Safeway Insurance");
        vMap.put(Company._SAFEWAY_INSURANCE_CO_OF_LA,"Safeway Insurance");
        vMap.put(Company._SECURITY_INSURANCE_CO_OF_HARTFORD,"Security Insurance");
        vMap.put(Company._SECURITY_NATIONAL_INSURANCE_CO_OF_FL,"Security Insurance");
        ...
        vMap.put(Company._ST_PAUL,"St. Paul Insurance");
        vMap.put(Company._ST_PAUL_FIRE_AND_MARINE,"St. Paul Insurance");
        ...
        vMap.put(Company._SUPERIOR_AMERICAN_INSURANCE,"Superior Insurance");
        vMap.put(Company._SUPERIOR_GUARANTY_INSURANCE,"Superior Insurance");
        ...
        vMap.put(Company._UNITED_PACIFIC_INSURANCE,"United Insurance");
        vMap.put(Company._UNITED_SECURITY,"United Insurance");
        ...
        vMap.put(Company._VIKING_COUNTY_MUTUAL_INSURANCE,"Viking Insurance");
        vMap.put(Company._VIKING_INSURANCE_CO_OF_WI,"Viking Insurance");
