...
public class CampaignCloneTest {
    private static final Logger LOGGER = LogManager.getLogger(CampaignCloneTest.class);
    private static String sSuffix = "20140122";
    ...
    public static void test()
        ...
        String vBudgetName = "Qts2Cmp.TOM.Broad.3";
    ...
    public static void cloneAdGroup(Connection iConnection, String iName, AdGroup iSourceAdGroup, long iTrafficCampaignID)
        ...
        cloneAdGroupKeywordsExactToBroad(iConnection, iSourceAdGroup, vTargetAdGroup);
    }
    ...
    public static void cloneAdGroupKeywordsExactToBroad(Connection iConnection, AdGroup iSourceAdGroup, AdGroup iTargetAdGroup)
            throws Exception {
        ...
        for (AdGroupKeyword vAdGroupKeyword : vAdGroupKeywords) {
            if (vAdGroupKeyword != null &&
                    vAdGroupKeyword.getApprovalStatus() != AdGroupKeyword.ApprovalStatus.disapproved &&
                    vAdGroupKeyword.getMatchType().equals(AdGroupKeyword.MatchType.exact)
            ){
                AdGroupKeywordDAO.insertAdGroupKeyword(
                        ...
                        AdGroupKeyword.MatchType.broad, //vAdGroupKeyword.getMatchType(),
                        -1,
                        null,
                ...
                // negative exact for broad
//                if (vAdGroupKeyword.getCriterionUse().equals(AdGroupKeyword.CriterionUse.biddable)) {
//                    AdGroupKeywordDAO.insertAdGroupKeyword(
//                            LOGGER,
//                            iConnection,
//                            iTargetAdGroup.getID(),
//                            vAdGroupKeyword.getKeywordID(),
//                            AdGroupKeyword.MatchType.exact,
//                            -1,
//                            null,
//                            AdGroupKeyword.Status.active,
//                            null,
