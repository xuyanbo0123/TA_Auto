...
public class HelloAnalyticsApi {
    ...
    private static Credential authorize() throws Exception {
        InputStream vInputStream = HelloAnalyticsApi.class.getResourceAsStream("/client_secret.json");
        InputStreamReader vStreamReader =   new InputStreamReader(
                vInputStream);
        // load client secrets
    ...
    private static String getFirstProfileId(Analytics analytics) throws IOException {
        ...
        if (accounts.getItems().isEmpty()) {
            ...
            String firstAccountId = accounts.getItems().get(1).getId();
            ...
            if (webproperties.getItems().isEmpty()) {
                ...
                String firstWebpropertyId = webproperties.getItems().get(4).getId();
    ...
    private static GaData executeDataQuery(Analytics analytics, String profileId) throws IOException {
        return analytics.data().ga().get("ga:" + profileId, // Table Id. ga: + profile id.
                "2013-12-08", // Start date.
                "2013-12-08", // End date.
                "ga:visits,ga:bounces,ga:goal1Completions,ga:goal2Completions") // Metrics.
                .setDimensions("ga:campaign, ga:adGroup,ga:keyword")
                .setSort("-ga:visits,ga:keyword")
